...
\item[\file{AdiabaticSolverGeneric.f90}] \hfill \\
  ...
  single most important argument to get right} -- see Section~\ref{sec:gotchas}.\\
...
\file{RMATPROPHybridSVDGenericDelta.f90} & All-SVD & \file{DeltaFunctionPlugins.f90} & Thin driver
  ...
  \texttt{'Radau'}. \textbf{Validated}: reproduces \file{RMATPROPHybridSVDRobin.x}'s own results
  exactly. \\
